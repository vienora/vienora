        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-amber-400">Vienora</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              The world's most exclusive luxury marketplace. We provide privileged access to rare finds and ultra-premium collections for the most discerning clients.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/exclusive" className="text-gray-400 hover:text-white transition-colors">Exclusive Collection</Link></li>
              <li><Link href="/categories" className="text-gray-400 hover:text-white transition-colors">All Categories</Link></li>
              <li><Link href="/private-sales" className="text-gray-400 hover:text-white transition-colors">Exclusive Offers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/track" className="text-gray-400 hover:text-white transition-colors">Track Your Order</Link></li>
      ...
      <div className="border-t border-slate-800">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mt-4 pt-4 border-t border-slate-800 text-center text-sm text-gray-400">
            <p>&copy; 2025 Vienora. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
